...
for i in xrange(len(ra)):
    ...
    sepCriteria1 = np.abs(sep-124.2) < arcLimit
    sepCriteria2 = np.abs(sep-30.7) < arcLimit
    sepCriteriaIndex = np.where((sepCriteria1) )
...
childFname='/Users/rlego/Dropbox/Research/KPNO/childIndex.reg'
hostFname='/Users/rlego/Dropbox/Research/KPNO/hostIndex.reg'
