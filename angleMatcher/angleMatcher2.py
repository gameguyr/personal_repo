...
### defining some constants for dates and file naming
logdate_today = datetime.datetime.today().strftime('%Y_%m_%d')
...
filename1 = '/Users/lego/Dropbox/Research/KPNO/som1sex.fits'
filename2 = '/Users/lego/Dropbox/Research/KPNO/som2sex.fits'
...
childFname = '/Users/lego/Dropbox/Research/KPNO/childIndex2_{0}.reg'.format(logdate_today)
hostFname = '/Users/lego/Dropbox/Research/KPNO/hostIndex2_{0}.reg'.format(logdate_today)
