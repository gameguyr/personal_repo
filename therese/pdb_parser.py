...
"""Takes a string representation of PDBID and returns true if it's valid. 
A valid PDBID is defined to be 4 characters long, 
consisting of #'s and letters."""
...
"""Takes a string containing the contents of a PDB file 
and returns a list containing the TITLE in the first 
element and a list of atoms in the second element."""
